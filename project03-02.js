...
var htmlCode = ""; //declaring a variable that will link to the html page
...
document.getElementById("gallery").innerHTML = htmlCode; //getting the gallery element from the html page and connecting it to the htmlCode variable
